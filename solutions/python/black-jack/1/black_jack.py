...
def higher_card(card_one, card_two):
    ...
    elif card_one_value < card_two_value: return card_two
...
def value_of_ace(card_one, card_two):
    ...
    if hand.__contains__('A'): return 1
    elif value_of_hand > 10: return 1
    else: return 11
...
def is_blackjack(card_one, card_two):
    ...
    hand = card_one, card_two
    if hand.__contains__('A') and (value_of_card(card_one) == 10 or value_of_card(card_two) == 10):
          return True
    else: return False
...
def can_double_down(card_one, card_two):
    ...
    value_of_hand = value_of_card(card_one) + value_of_card(card_two)
    if value_of_hand < 9 or value_of_hand > 11: return False
    else: return True
